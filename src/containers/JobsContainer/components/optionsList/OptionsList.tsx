...
const OptionsList = ({ options, onSelectText, selected, isCampus, isCampusDiplome }: Props) => {
  ...
  return (
    <div className={classes.root}>
      {formattedData.map((el) => (
        <div key={el.label} className={classes.item} onClick={() => onSelectText(isCampus || isCampusDiplome ? el.label : el.id)}>
